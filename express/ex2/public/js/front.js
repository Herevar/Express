...
const form = document.querySelector('form') // do 'złapania'/odowlania sie elementu 'form', ktory ma metode 'submit' ('reset' itp)
//mozna elementowi nadac klase, id i 'łapać' po niej  => const form  = document.getElementById('signup');
...
form.addEventListener('submit', async event =>{
    ...
    const res = await fetch('/calc/check',{ //na dany adres
